...
function buildReport(pageResults, issues) {
  ...
  const verdict =
    severe.length > 0
      ? "Not ready to ship publicly because at least one P0/P1 issue was captured. Fix the highest-severity browser health and product-flow failures first."
      : issues.length
        ? "No P0/P1 issues were captured. Address the remaining lower-severity findings before public launch."
