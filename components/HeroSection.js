      ...
      tl.set([promptRef.current, responseRef.current, rightImageRef.current], {
        ...
        .call(() => {
          ...
          if (responseRef.current)
            responseRef.current.textContent = item.response;
        })
        ...
        .to({}, { duration: 2 })
        .to(
          [promptRef.current, responseRef.current, rightImageRef.current],
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Right — synced product UI placeholder */}
          <div
            ref={rightImageRef}
            style={{
